                ...
                <section class="hero">
                    <div class="container">
                        <div class="hero-inner">
                            <div class="hero-copy">
                                <h1 class="hero-title mt-0">SIPEKA</h1>
                                <p class="hero-paragraph">Memanajemen Restaurant dengan Lebih Mudah</p>
                            ...
                            <div class="hero-illustration">
                                <div class="hero-shape hero-shape-1">
                                    <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg"
                                        style="overflow:visible">
                                        <circle class="anime-element fadeup-animation" cx="20" cy="20" r="20"
                                            fill="#FFD8CD" fill-rule="evenodd" />
                                    </svg>
                                </div>
                                <div class="hero-shape hero-shape-2">
                                    <svg width="88" height="88" xmlns="http://www.w3.org/2000/svg"
                                        style="overflow:visible">
                                        <circle class="anime-element fadeup-animation" cx="44" cy="44" r="44"
                                            fill="#FFD2DA" fill-rule="evenodd" />
                                    </svg>
                                </div>
                                            ...
                                            <g>
                                                ...
                                                <g class="anime-element fadeleft-animation">
                                                    ...
                                                    <text font-family="AppleColorEmoji, Apple Color Emoji"
                                                        font-size="19" fill="#11103E" transform="translate(28 221)">
                                                ...
                                                <g class="anime-element fadeleft-animation">
                                                    ...
                                                    <text font-family="AppleColorEmoji, Apple Color Emoji"
                                                        font-size="16" fill="#11103E" transform="translate(325 257)">
                        ...
                        <div class="features-inner section-inner">
                            <div class="features-header text-center">
                                <div class="container-sm">
                                    <h2 class="section-title mt-0">Sistem Informasi Manajemen Pelayanan Kasir Restaurant
                                    </h2>
                            ...
                            <div class="features-wrap">
                                <div class="feature text-center is-revealing">
                                    <div class="feature-inner">
                                        ...
                                        <h4 class="feature-title h3-mobile mb-8">Pelayanan</h4>
                                        <p class="text-sm">Memfasilitasi proses pelayanan kasir</p>
                                    </div>
                                </div>
                                <div class="feature text-center is-revealing">
                                    <div class="feature-inner">
                                        ...
                                        <h4 class="feature-title h3-mobile mb-8">Laporan</h4>
                                        <p class="text-sm">Memudahkan dalam pembuatan laporan usaha</p>
                                    </div>
                                </div>
                                <div class="feature text-center is-revealing">
                                    <div class="feature-inner">
                                        ...
                                        <h4 class="feature-title h3-mobile mb-8">Kontrol</h4>
                                        <p class="text-sm">Memudahkan dalam meengontrol kinerja pegawai</p>
                                    </div>
                                </div>
                                <div class="feature text-center is-revealing">
                                    <div class="feature-inner">
                                        ...
                                        <h4 class="feature-title h3-mobile mb-8">Transparansi</h4>
                                        <p class="text-sm">Transaparansi perhitungan keuangan restaurant</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <footer class="site-footer">
                <div class="container">
                    <div class="site-footer-inner has-top-divider">
                        ...
                        <div class="footer-copyright">&copy; 2020 SIPEKA, all rights reserved</div>
                    </div>
                </div>
            </footer>
        </div>
